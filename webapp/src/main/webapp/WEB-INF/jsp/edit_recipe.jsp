            ...
            <form:form autocomplete="off" modelAttribute="recipeForm" action="${createRecipe}" method="post"
                ...
                <div class="form-row mb-4">
                    ...
                    <form:input path="name" type="text" id="recipe_title" class="form-control"
                                placeholder="${recipeNamePlaceholder}" value="${recipeName}"/>
                ...
                <div class="form-row mb-4">
                    ...
                    <form:input path="description" type="text" id="recipe_description" cssClass="form-control"
                                placeholder="${descriptionPlaceholder}" value="${recipeDescription}"/>
                ...
                <div id="clonedInput1" class="to_clone clonedInput_1 flex">
                    <div class="new-recipe-ingredient-select">
                        ...
                        <form:select path="ingredients" cssClass="form-control select-ingredient-recipe" multiple="">
                            <c:forEach var="ingredient_type" items="${allIngredients}">
                                <form:option
                                        value="${ingredient_type.id}">${ingredient_type.name} (<spring:message code="${ingredient_type.typeOfServing}"/>)</form:option>
                            </c:forEach>
                        </form:select>
                    </div>
                    ...
                    <button type="button" id = "0" onclick="delete_item_edit_recipe(this)" class="btnDel_2 bg-transparent text-center delete-ingredient-button">
