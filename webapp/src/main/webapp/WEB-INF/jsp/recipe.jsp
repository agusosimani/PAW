                    ...
                    <div class="ingredients-tags-div">
                        ...
                        <fieldset class="rating rating-recipe">
                            ...
                            <input onclick="add_rate(3)" type="radio" id="three" name="" value="3"
                                   <c:if test="${previous_rate >= 3}">checked</c:if>/><label class="full" for="three"
                            ...
                            <input onclick="add_rate(0.5)" type="radio" id="half" name="" value="half"
                                   <c:if test="${previous_rate >= 0.5}">checked</c:if>/><label class="half" for="half"
        ...
        <div class="card card-comments">
            <div class="card-body">
                ...
                <form:form modelAttribute="commentForm" action="${addCommentUrl}" method="post">
                    <form:label cssClass="comment-add-label" path="comment"><spring:message code="comment.Add"/></form:label>
...
<form:form action="${cookRecipe}" method="post">
    <button type="submit" title="<spring:message code="cookButton"/>" class="btn btn-green btn-cook"><i class="fas fa-utensils fa-2x"></i></button>
</form:form>
